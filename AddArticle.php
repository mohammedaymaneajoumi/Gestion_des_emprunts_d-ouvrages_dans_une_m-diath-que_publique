...
<head>
    ...
    <link rel="stylesheet" href="css2/AddArticle.css">
</head>
<body>
                        ...
                        <article class="part card-details">
                            <form action="" if="cc-form" autocomplete="off">
                                <div class="group card-name">
                                    <label for="name">Item Title <span style=" color: red;">*</span></label>
                                    <input type="text" id="name" class="" type="text" maxlength="30" placeholder="...">
                                </div>
                                <div class="group card-name">
                                    <label for="name">Auteur Name</label>
                                    <input type="text" id="name" class="" type="text" maxlength="30" placeholder="...">
                                </div>
                                <div class="group card-name">
                                    <label for="name">Cover Image</label>
                                    <input type="file" id="name" class="" type="text" placeholder="..." style='font-size: 13px; font-family: "Tajawal", Arial ;border: 1px solid #d9d9d9; margin: 10px 0 0 0;'>
                                </div>
                                <div class="group card-name">
                                    <label for="name">Item State <span style=" color: red;">*</span></label>
                                    <input type="text" id="name" class="" type="text" maxlength="30" placeholder="...">
                                </div>
                                <div class="group card-name">
                                    <label for="name">Item Type <span style=" color: red;">*</span></label>
                                    <input type="text" id="name" class="" type="text" maxlength="30" placeholder="...">
                                </div>
                                <div class="group card-name">
                                    <label for="name">publishing Date</label>
                                    <input type="date" id="name" style='font-size: 13px; font-family: "Tajawal", Arial ;' type="text" maxlength="30" placeholder="...">
                                </div>
                                <div class="group card-name">
                                    <label for="name">Date of Purchase <span style=" color: red;">*</span></label>
                                    <input type="date" id="name" style='font-size: 13px; font-family: "Tajawal", Arial ;' type="text" maxlength="30" placeholder="...">
                                </div>
                                <div class="group card-name">
                                    <label for="name">pages number</label>
                                    <input type="text" id="name" class="" type="text" maxlength="30" placeholder="...">
                                </div>
