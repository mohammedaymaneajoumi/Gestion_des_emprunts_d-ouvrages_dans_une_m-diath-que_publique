...
<body>
    ...
    <main class="container">
        <div class="row">
                ...
                $card_data = [['image' => 'img/poster1.jpg','title' => 'Company of One','author' => 'Paul Jarvis','publication_date' => '15 janvier 2019','condition' => 'Neuf','type' => 'livre','pages' => '220 pages'],
                    // add more cards here...
                ];

                // Loop through the card data array and generate a card for each item
                foreach ($card_data as $card) {
                ?>
                <div class="col-md-3">
                    <section class="card">
                    <div class="product-image">
                        <img src="<?php echo $card['image']; ?>" alt="<?php echo $card['title']; ?>" draggable="false" />
                    </div>
                    ...
                    <input type="checkbox" name="dialog_state" id="dialog_state_<?php echo $card['title']; ?>" class="dialog_state">
                    <div id='dialog'>
                        <label id="dlg-back" for="dialog_state_<?php echo $card['title']; ?>"></label>
                        <div id='dlg-wrap'>
                        <label id="dlg-close" for="dialog_state_<?php echo $card['title']; ?>"><i class="fa-sharp fa-solid fa-circle-xmark"></i></label>
                    ...
                    <main id='main_<?php echo $card['title']; ?>' class='main_area'>
                        <div class='center'>
                        <label class="button mt-4" for="dialog_state_<?php echo $card['title']; ?>"><i class="icon ion-ios-upload-outline"></i> Reserve Now</label>
                        </div>
                        <div id='console_<?php echo $card['title']; ?>'></div>
                    </section>
                    </div>
                <?php
                }
